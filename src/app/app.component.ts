                                        ...
                                        <div class="span7">
                                            ...
                                            <ol type="1">
                                                ...
                                                <li>Where can i get the secret code mentioned in the documentation? <br> - Open business account at: <a href="https://www.pesapal.com/">https://www.pesapal.com</a> (for Live system)<br> or <a href="https://developer.pesapal.com/api3-demo-keys.txt">
                                                  https://developer.pesapal.com/api3-demo-keys.txt</a>(For
                                                ...
                                                <span title="click me" style="cursor: pointer;" *ngIf="iframe" (click)="openBottomSheet()"><svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="26" height="26" viewBox="0 0 26 26" style=" fill:#000000;">
                                                  ...
                                                  <form  [formGroup]="t_id">
                                                  <input [placeholder]="'copy and paste your tracking ID here'" [style.width]="'100%'" type="text" formControlName="tracking_id">
                                                  <input (click)="getTransactionStatus()" type="submit" 
                                                  [value]="'Get Transaction Status '" class="btn" [disabled]="!t_id.valid">
                                                  <div>{{tracking_status}}</div>
                                                  <br>
                                                </form>
                                              </ol>
                                        </div>
...
export class AppComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this['t_id'] = this.formBuilder.group({
  ...
  getTransactionStatus(){ //Get Transaction Status
    ...
    this.http.get(`${this.demoUrl}/v3/api/Transactions/GetTransactionStatus?orderTrackingId=
    ${this.t_id.getRawValue().tracking_id}`, {headers: headers})
    .subscribe(
      (response:any) => { 
